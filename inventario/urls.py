...
from . import views
from .views import ProductoListCreateView, ProductoUpdateView, crear_producto_inventario, dashboard_general, editar_producto, eliminar_producto, lista_productos
